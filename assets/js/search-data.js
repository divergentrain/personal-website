...
ninja.data = [{
    ...
    handler: () => {
      window.location.href = "/personal-website/";
          ...
          section: "Navigation",
          handler: () => {
            window.location.href = "/personal-website/blog/";
          },
        },{id: "nav-publications",
          title: "publications",
      ...
      handler: () => {
          ...
          section: "News",handler: () => {
              window.location.href = "/personal-website/news/announcement_2/";
        ...
        section: 'Socials',
        handler: () => {
          window.open("https://www.linkedin.com/in/sudnar-guru", "_blank");
        },
      },{
        id: 'social-orcid',
        title: 'ORCID',
        ...
        section: 'Socials',
        handler: () => {
          window.open("/personal-website/feed.xml", "_blank");
        },
      },{
        id: 'social-scholar',
